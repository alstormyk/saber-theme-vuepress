<template>
  <div class="post">
    <article>
      ...
      <hr>
      <hr>
      <h2 id="typographic">Typographic replacements</h2>
...
line 3 of code
      ...
      <p>Autoconverted link <a href="https://github.com/nodeca/pica">https://github.com/nodeca/pica</a> (enable linkify
        to see)</p>
      ...
      <p>see <a href="https://github.com/markdown-it/markdown-it-emoji#change-output">how to change output</a> with
        twemoji.</p>
      <h3 id="subsuper"><a href="https://github.com/markdown-it/markdown-it-sub">Subscript</a> / <a
      ...
      <h3 id="abbrev"><a href="https://github.com/markdown-it/markdown-it-abbr">Abbreviations</a></h3>
      <p>This is <abbr title="Hyper Text Markup Language">HTML</abbr> abbreviation example.</p>
      <p>It converts “<abbr title="Hyper Text Markup Language">HTML</abbr>”, but keep intact partial entries like
        “xxxHTMLyyy” and so on.</p>
      ...
      <section class="footnotes">
        <ol class="footnotes-list">
          ...
          <li id="fn2" class="footnote-item">
            <p>Footnote text. <a href="#fnref2" class="footnote-backref">↩︎</a> <a href="#fnref2:1"
...
import Highlight from 'vue-highlight-component'
  ...
  export const attributes = {
    layout: 'post',
    title: 'Markdown Syntax Guide in Vue',
    date: '2019-02-23',
    excerpt: 'A markdown example.'
  }
